<div id="products-tab" class="wow fadeInUp">
    <div class="container">
		...
		<form method="POST" class="form-inline" action="<?php echo base_url();?>/home_controller/cariukm/<?php echo $idlink;?>">
				<div class="form-group">
					<input style="width: 300px;" type="text" placeholder="Cari produk dari kategori <?=$judul?>" name="cariukm" class="form-control col-md-8">
				</div>
				<div class="form-group">
