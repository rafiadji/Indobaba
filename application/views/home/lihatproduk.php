    	...
    	<div class="row">
    		<div class="col-md-12">
    			<div class="desk-produk">
	    			<h4>Produk-produk di Indobaba</h4>
	    			<br/>
	    			Produk yang ada di Indobaba adalah produk ukm/umkm/ikm yang kami jual dengan harga PABRIK. Silahkan pilih produk sesuai yang anda butuhkan dan tanyakan pada produsennya tentang produk yang akan anda beli bila anda butuh informasi lebih lengkap 
    			</div>
    		</div>
    	</div>
		<div class="container">
				...
				<div class="panel-body">
						<div class="row">
							...
							<div class="col-md-12" style="text-align: center;">
								<img src="<?php echo $link;?>" id="loadingcari" style="display:none;">
							</div>
						</div>
				</div>
			</div>
                ...
                <div class="product-item">
						...
						<div class="body">
							...
							<div class="row-btn" style="text-align: center">
								...
								<button type="button" onclick="beli(<?php echo $row->ID_PRODUK ?>)" class="btn btn-puji btn-success" data-toggle="modal" data-target="#myModal">Beli</button>
								<?php else: ?>
