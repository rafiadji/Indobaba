<div id="products-tab" class="wow fadeInUp">
    <div class="container">
        ...
        <form method="POST" class="form-inline" action="<?php echo base_url();?>home_controller/cariLihatproduk">
						<div class="form-group">
							<input class="form-control" style="width: 400px;" placeholder="Cari produk" type="text" name="cariprodukkategori" value="">
						</div>
						<div class="form-group">
							<input style="width: 100px;" type="text" placeholder="Harga Min" name="min" class="form-control col-md-8">
						</div>-
						<div class="form-group">
							<input style="width: 100px;" type="text" placeholder="Harga Max" name="max" class="form-control col-md-8">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="submit" name="cariukmsbmt" value="Cari produk" class="btn btn-success">
						</div>
					</form>
            <?php 
            	if($tampill):
