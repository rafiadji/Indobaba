...
<?php endif; ?>
<form method="POST" action="<?=base_url();?>admin_produk/ubahProduksubmit">
	...
	<tr>
		...
		<td>
			<select name="ID_TOKO">
				...
				<option value="<?=$rows->ID_TOKO?>" <?php if($rows->ID_TOKO == $edit->ID_TOKO){ echo 'selected';}?>><?=$rows->NM_TOKO?></option>
				<?php } ?>
			</select>
		</td>
	</tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$.ajax({
			type:"POST",
			url:"<?=site_url('admin_produk/dapatSubkategoriedit');?>",
