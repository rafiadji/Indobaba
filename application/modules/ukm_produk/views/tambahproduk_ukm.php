...
<?php endif; ?>
<form method="POST" action="<?=base_url();?>/ukm_produk/tambahProduksubmit">
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-body">
			<input type="submit" value="Tambah Produk" class="btn btn-default btn-lg"/>
			<a href="<?php echo base_url('ukm_produk') ?>" class="btn btn-info btn-lg">Kembali</a>
		</div>
	</div>
</div>
<div class="col-md-8">
