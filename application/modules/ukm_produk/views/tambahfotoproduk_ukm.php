<form method="POST" action="<?=base_url();?>ukm_produk/tambahfotoProduksubmit" enctype="multipart/form-data">
...
<div class="col-md-12">
	...
	<div class="panel-body">
		...
		<a href="<?php echo base_url('ukm_produk/fotoProduk/'.$edit->ID_PRODUK) ?>" class="btn btn-info btn-lg">Kembali</a>	
	</div>
</div>
</div>
