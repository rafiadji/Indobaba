	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_ekspedisi" value="<?php echo $tampil->NAMA_EKSPEDISI;?>" class="form-control">
			...
			<div class="form-group">
				...
				<textarea name="des_ekspedisi" class="form-control"><?php echo $tampil->DES_EKSPEDISI;?></textarea>
