<div class="row">
<?php if($rekening) : ?>
<form method="POST" action="<?=base_url();?>/admin_rekening/ubahRekeningukm">
<div class="col-md-12">
	<input type="hidden" class="form-control" name="ID_PEMILIK" value="<?=$id?>"/>
	<input type="hidden" class="form-control" name="ID_REKENING" value="<?=$rekening->ID_REKENING?>"/>
	<div class="panel panel-default">
		<div class="panel-body">
			<input type="submit" value="Edit Rekening UKM" class="btn btn-default btn-lg"/>
...
<?php else :?>
<form method="POST" action="<?=base_url();?>/admin_rekening/tambahRekeningukm">
<div class="col-md-12">
	<input type="hidden" class="form-control" name="ID_PEMILIK" value="<?=$id?>"/>
	<div class="panel panel-default">
		<div class="panel-body">
			<input type="submit" value="Tambah Rekening UKM" class="btn btn-default btn-lg"/>
			<a href="<?php echo base_url('admin_ukm') ?>" class="btn btn-info btn-lg">Kembali</a>
		</div>
	</div>
</div>
